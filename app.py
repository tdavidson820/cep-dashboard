        ...
        html.Div([
            ...
            html.Div([
                html.Div([
                    ...
                    ], style={'background': COLORS['white'], 'border': f'1px solid {COLORS["border"]}', 'borderRadius': '16px', 'padding': '16px', 'boxShadow': '0 12px 26px rgba(15,23,42,0.10)', 'lineHeight': '1.35', 'overflow': 'visible'})
